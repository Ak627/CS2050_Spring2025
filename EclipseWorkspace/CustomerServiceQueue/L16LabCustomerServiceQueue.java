            ...
            if (scanner.hasNextInt()) {
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        System.out.println(serviceQueue.displayQueue());
                        break;
...
class CustomerQueue{
	private ArrayList<Customer> ArrayListQueue; 

	public CustomerQueue() {
        this.ArrayListQueue = new ArrayList<>();
    }


    public boolean isEmpty() {
        return this.ArrayListQueue.isEmpty();
    }


    public void enqueue(Customer item) {
        this.ArrayListQueue.add(item);
    }
    ...
    public Customer dequeue() {
        ...
        return this.ArrayListQueue.remove(0);
    }
    ...
    public Customer peek() {
        ...
        return this.ArrayListQueue.get(0);
    }


    public int size() {
        return this.ArrayListQueue.size();
    }


    public String displayQueue() {
    	String CustName = null;
        if (!this.ArrayListQueue.isEmpty()) {
        	for(int i = 0; i < size(); i ++) {
        		CustName = this.ArrayListQueue.get(i).GetName() ;
        	}
        	return "Head ->" + CustName + "<- Tail";
        } else {
            return "<<empty Queue>>";
        }
    }
